...
replace_once(
    "desktop/src/core/bridge.test.ts",
    "  selectedRole: null,\n  hostLifecycle: \"idle\",\n",
    "  selectedRole: \"host\",\n" + snapshot_fields.replace("    ", "  ") + "  hostLifecycle: \"idle\",\n",
)
replace_once(
    "desktop/src/core/client.test.ts",
    "    selectedRole: null,\n    hostLifecycle: \"idle\",\n",
    "    selectedRole: \"host\",\n" + snapshot_fields + "    hostLifecycle: \"idle\",\n",
)
...
(ROOT / "scripts/fix-block14-frontend-fixtures.py").unlink()
